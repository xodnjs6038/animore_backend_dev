...
(
    id           int                                 NOT NULL AUTO_INCREMENT comment '장소 고유번호',
...
(
    ...
    status       int(10)            NOT NULL default 1 comment '회원 상태(0:Stop, 1:Active)',
    ...
    use_car      int(10)            NULL comment '차량 여부',
    created_date timestamp                   DEFAULT CURRENT_TIMESTAMP NOT NULL comment '생성일',
    updated_date timestamp                   DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP comment '업데이트일',
    primary key (id),
...
(
    ...
    status       int(10)      NOT NULL default 0 comment '봉사 상태(0:Ready, 1:Done)',
    date         date         NOT NULL comment '봉사 날짜',
    time         varchar(150) NULL comment '봉사 시간',
    start_date   datetime     NULL comment '봉사 신청 시작 시간',
    end_date     datetime     NULL comment '봉사 신청 종로 시간',
...
(
    ...
    status       int(10) NOT NULL default 0 comment '봉사 신청 상태(0:Pending, 1:Approved, 4:Rejected)',
    use_car      int(10) NOT NULL default 0 comment '차량 지원(0:Not Use, 1:Use)',
